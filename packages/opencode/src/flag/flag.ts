export namespace Flag {
  ...
  // Support both SNOWCODE_CONFIG_DIR and OPENCODE_CONFIG_DIR for backwards compatibility
  export const OPENCODE_CONFIG_DIR = process.env["SNOWCODE_CONFIG_DIR"] || process.env["OPENCODE_CONFIG_DIR"]
